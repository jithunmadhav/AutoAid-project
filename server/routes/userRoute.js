...
import { forgotPassword, resendOtp, resetpassword, userLogin, userLogout, userSignup, verifyUserSignup } from '../controller/userController.js';
...
router.post('/forgotPassword',forgotPassword).post('/resetPassword',resetpassword)
